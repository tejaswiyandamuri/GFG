<h2><a href="https://www.geeksforgeeks.org/problems/construct-list-using-given-q-xor-queries/1?_gl=1*1qd8lps*_up*MQ..*_gs*MQ..&gclid=CjwKCAjwxb7RBhA5EiwAQ-AAdOJBT1QJZaYR3_y3ZBQYbNc1sMWyRmT72W5F1x1wubdLcoEZU1REQRoCgjcQAvD_BwE&gbraid=0AAAAAC9yBkAXSFUV2IEWzMDqLFfznfQIQ">Construct List using XOR Queries</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">There is an array that initially contains only a single value,&nbsp;<strong>0</strong>.&nbsp;</span></p>
